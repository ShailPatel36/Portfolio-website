...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "5d0ef864-5960-406d-bfe9-91753f591df7");
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> 
       ...
       onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        type='submit'
        className='py-3 px-8 w-max flex items-center justify-center gap-2 text-white bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'
